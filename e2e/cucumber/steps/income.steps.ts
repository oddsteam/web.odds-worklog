...
When("I submit income for {int} work days and {int} hours of special work at {int} baht per hour", { timeout: 60000 }, async function (workDays: number, workingHours: number, specialRate: number) {
